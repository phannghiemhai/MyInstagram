 ...
 */
public class ModalLikeImageDAO {

    private static ModalLikeImageDAO _instance = null;
    ...
    private ModalLikeImageDAO() {
        _connector = new SQLiteDAO(Config.getParam("sqlite", "raw_data"));
    }

    public static ModalLikeImageDAO getInstance() {
        if (_instance == null) {
            _instance = new ModalLikeImageDAO();
        }
        return _instance;
    }
