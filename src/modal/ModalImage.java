...
public class ModalImage {
    ...
    private static ModalImage _instance = null;
    ...
    private ModalImage() {
        ...
        Collection<ImageEntity> entities = ModalImageDAO.getInstance().getEntities(null, null, null, null, "id ASC", 0);
        for (ImageEntity entity : entities) {
            _imageIds.add(entity.id);
            _images.put(entity.id, entity);
            insertToMap(entity);
        }
        _seq = ModalImageDAO.getInstance().getSeq();
    }
    ...
    public static ModalImage getInstance() {
        if (_instance == null) {
            _instance = new ModalImage();
        }
        return _instance;
    }
